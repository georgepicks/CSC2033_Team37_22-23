...
Description: Initialises several components of the app incliding: The connection to the database, the Flask login
manager, the html blueprints, and returning in case of an error, returing error pages.
"""
